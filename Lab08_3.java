...
public class Lab08_3 {
    ...
    public static void findInOrder(Order [] orderList, String foodName){
        String Id;
        int count = 0;
        for(Order i: orderList){
            Id = i.findOrder(foodName);
            if (Id.equals("None")){
...
class Order{
    ...
    public String findOrder(String s1){
        for(OrderItem i: this.orderItems){
            if (s1.equals(i.getData())){
                return this.orderId;
            }
